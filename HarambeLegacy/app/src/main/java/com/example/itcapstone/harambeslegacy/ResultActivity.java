...
public class ResultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.itcapstone.harambeslegacy.R.layout.activity_result);

		TextView textResult = (TextView) findViewById(com.example.itcapstone.harambeslegacy.R.id.textResult);
